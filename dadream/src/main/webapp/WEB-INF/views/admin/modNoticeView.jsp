        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main class="NoticeMain">
                    <h3>공지 수정하기</h3>
                    <form method="post" action="/admin/modNotice.do">
                        <div class="Writer_Cate_Title">
                            관리자 : <input type="text" value="${noticeView.user_Id}" name="user_Id" disabled />
                            카테고리 : <input type="text" class="notice_cate" value="${noticeView.notice_Category}" name="notice_Category"/>
                            제목 : <input type="text" class="notice_title" value="${noticeView.notice_Title}" name="notice_Title"  />
                            <input type="hidden" value="${noticeView.notice_Num}" name="notice_Num" />
                        </div>
                        <!-- <div class="">
                            카테고리 : <input type="text" value="${noticeView.notice_Category}" name="notice_Category"/>
                            제목 : <input type="text" value="${noticeView.notice_Title}" name="notice_Title"  />
                            등록일자 : <input type="datetime" value="${noticeView.notice_Date}" name="notice_Date" disabled/>
                        </div> -->
                        <div class="NoticeContentForm">
                            내용: <textarea name="notice_Text" class="Text">${noticeView.notice_Text}</textarea>
                        </div>
                        <div class="Btns">
                            <input type="submit" value="수정완료"><input type="reset" value="다시입력">
                        </div>
                    </form>
                </main>
