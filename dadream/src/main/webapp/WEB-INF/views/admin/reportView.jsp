            ...
            <div id="layoutSidenav_content">
                <main class="NoticeMain">   
                    ...
                    <div class="Writer_Cate_Title">
                        신고자: <input type="text" value="${rpContents.user_Id}" disabled>
                        <div style="display: flex;">
                            제목:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${rpContents.rp_Title}" disabled>&nbsp;&nbsp;&nbsp;&nbsp;신고날짜:&nbsp;<input type="text" value="${rpContents.rp_Date}" disabled>
                        </div>
                        <div style="display: flex;">
                        매물명:&nbsp;<input type="text" value="${rpContents.dealing[0].dl_Title}" disabled>&nbsp;&nbsp;&nbsp;&nbsp;
                        매물번호:&nbsp;<a href="/dealingview.do?dl_Num=${rpContents.dealing[0].dl_Num}">${rpContents.dealing[0].dl_Num}</a>
                        </div>
                    </div>
                    <div class="NoticeContentForm">
                        내용: <textarea class="Text" disabled>${rpContents.rp_Content}</textarea>
                    </div>
                    </form>
                    <div class="Btns">
                        <form method="post" action="/admin/reportState.do">
                            <input type="submit" name="rp_State" value="처리중">
                            <input type="hidden" name="dl_ReportNum" value="${rpContents.dl_ReportNum}">
                        </form>
                        <form method="post" action="/admin/reportState.do">
                            <input type="submit" name="rp_State" value="반려">
                            <input type="hidden" name="dl_ReportNum" value="${rpContents.dl_ReportNum}">
                        </form>
                        <form method="post" action="/admin/reportState.do">
                            <input type="submit" name="rp_State" value="처리완료">
                            <input type="hidden" name="dl_ReportNum" value="${rpContents.dl_ReportNum}">
                        </form>    
