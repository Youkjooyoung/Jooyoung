        ...
        <div id="layoutSidenav_content">
            <main class="NoticeList">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Dealing Management</li>
                </ol>
                <h3>매물내역</h3>
                                ...
                                <table id="datatablesSimple">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 10%;">매물종류</th>
                                            <th style="width: 55%;">매물명</th>
                                            <th style="width: 10%;">매매종류</th>
                                    ...
                                    <tbody>
                                        <c:forEach var="dl" items="${dealingsList}">
                                            <tr>
                                                ...
                                                <td style="width: 10%;">${dl.dl_Num}</td>
                                                <td style="width: 10%;">${dl.dl_Form}</td>
                                                <td style="width: 55%;"><a
                                                        href="${contextPath}/dealingview.do?dl_Num=${dl.dl_Num}">${dl.dl_Title}</a>
                                                </td>
                                                <td style="width: 10%;">${dl.dl_Form2}</td>
                                                <td style="width: 20%;">${dl.dl_Date}</td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
