        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <li><a class="dropdown-item" href="/productmain.do">가구</a></li>
                    <li>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main class="NoticeMain">
                    <h3>공지 상세보기</h3>
                    <form method="post" action="/admin/modNoticeView.do">
                        <div class="Writer_Cate_Title">
                            관리자 : <input type="text" value="${noticeView.user_Id}" name="user_Id" disabled />
                            카테고리 : <input type="text" class="notice_cate" value="${noticeView.notice_Category}" name="notice_Category" disabled/>
                            제목 : <input type="text" class="notice_title" value="${noticeView.notice_Title}" name="notice_Title" disabled />
                            <input type="hidden" value="${noticeView.notice_Num}" name="notice_Num"/>
                        </div>
                        <!-- <div class="Writer_Cate_Title">
                            카테고리 : <input type="text" value="${noticeView.notice_Category}" name="notice_Category" disabled/>
                            제목 : <input type="text" value="${noticeView.notice_Title}" name="notice_Title" disabled />
                            등록일자 : <input type="datetime" value="${noticeView.notice_Date}" name="notice_Date" disabled/>
                        </div> -->
                        <div class="NoticeContentForm">
                            내용: <textarea class="Text" disabled>${noticeView.notice_Text}</textarea>
                            <input type="hidden" name="notice_Text" value="${noticeView.notice_Text}" />
                        </div>
                        <div class="Btns">
                                <input type="submit" value="수정하기">
                            </form>
                            <form method="post" action="/admin/deleteNotice.do">
