...
CREATE SEQUENCE SEQ_CART_ID START WITH 1000 INCREMENT BY 1 NOCACHE NOCYCLE;

ALTER TABLE CART ADD CONSTRAINT FK_CART_USER FOREIGN KEY (USER_ID)
  REFERENCES USERS(USER_ID);
ALTER TABLE CART ADD CONSTRAINT FK_CART_PRODUCT FOREIGN KEY (PROD_NO)
  REFERENCES PRODUCT(PROD_NO);
  
  ALTER TABLE TRANSACTION ADD PAYMENT_AMOUNT NUMBER(10);

  ALTER TABLE TRANSACTION
  MODIFY PAYMENT_OPTION VARCHAR2(10 CHAR);
