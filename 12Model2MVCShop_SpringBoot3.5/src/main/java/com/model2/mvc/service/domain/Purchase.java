...
public class Purchase {
	...
	public String toString() {
		return "PurchaseVO [buyer=" + buyer + ", paymentOption=" + paymentOption + ", purchaseProd=" + purchaseProd
				+ ", receiverName=" + receiverName + ", tranCode=" + tranCode + ", tranNo=" + tranNo
