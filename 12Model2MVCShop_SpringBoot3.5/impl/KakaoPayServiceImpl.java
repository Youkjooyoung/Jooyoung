...
public class KakaoPayServiceImpl implements KakaoPayService {
	...
	public Map<String, Object> readyPayment(Map<String, Object> param) throws Exception {
		...
		PAYMENT_CACHE.put(tid, param); // tid 키 캐시
		String rid = (String) param.get("rid");
		if (rid != null) {
			RID_TID.put(rid, tid); // rid→tid 매핑
			RID_CACHE.put(rid, param); // rid 키 캐시(보조)
		}
		return res.getBody();
	}
