...
<tr>
	...
	<!-- 				<a href="/listProduct.do?menu=search" target="rightFrame">상 품 검 색</a> -->
			...
			<tr>
				...
				<td class="Depth03">
				  	<a href="${pageContext.request.contextPath}/layout/recentProduct.jsp"
					   onclick="window.open(this.href, 'recentProduct',
					                        'width=500,height=400,scrollbars=yes'); return false;">
					  					최근 본 상품
					</a>
				</td>
			</tr>
