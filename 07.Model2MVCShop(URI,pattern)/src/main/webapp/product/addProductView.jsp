	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="manuDate" readonly="readonly" class="ct_input_g"  
						style="width: 100px; height: 19px"	maxLength="15" minLength="6"/>
	...
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
							  ...
							  <td bgcolor="D6D6D6" width="1"></td>
							  <td class="ct_write01">
							    <input type="file" id="uploadFiles" name="uploadFiles" class="ct_input_g"
...
<script src="${pageContext.request.contextPath}/javascript/preview.js"></script>
</body>
</html>