...
public class ProductDaoImpl implements ProductDao {
	...
	public String findProduct(Product product) throws Exception {
		return sqlSession.selectOne("ProductMapper.findProduct", product);
	}
...
//	    int result = sqlSession.delete("ProductMapper.deleteProductImage", imgId);
//	    System.out.println("삭제 실행 IMG_ID=" + imgId + " → 결과=" + result);
	}
