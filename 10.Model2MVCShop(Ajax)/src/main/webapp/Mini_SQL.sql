...
-- 8) 스키마 변경 (추가/수정)
------------------------------------------------------------
-- TRANSACTION 테이블 컬럼명 수정 및 컬럼 추가
...
-- USERS 테이블 주소 관련 컬럼 추가
ALTER TABLE USERS 
  ADD ( ZIPCODE     VARCHAR2(10 CHAR),
        ADDR_DETAIL VARCHAR2(200 CHAR) );

-- USERS 테이블 구글 아이디 추가
ALTER TABLE USERS ADD GOOGLE_ID VARCHAR2(50 CHAR);

-- USERS 테이블 USER_ID 데이터 길이 변경(Google)
ALTER TABLE USERS 
MODIFY USER_ID VARCHAR2(50 CHAR);