        ...
        <form name="purchaseForm">
          ...
          <table class="form-table">
            ...
            <tr>
			  <th>배송주소</th>
			  <td>
			    <input type="text" id="zipcode" name="zipcode" value="${purchase.zipcode}" 
			           readonly class="input-text" style="width:120px;"/>
			    <button type="button" id="btnAddr" class="btn-gray">주소검색</button><br/>
			    <input type="text" id="divyAddr" name="divyAddr" value="${purchase.divyAddr}"
			           readonly class="input-text" style="width:80%; margin-top:5px;" required/><br/>
			    <input type="text" id="addrDetail" name="addrDetail" value="${purchase.addrDetail}"
			           class="input-text" style="width:80%; margin-top:5px;" required/>
			  </td>
			</tr>
            <tr><th>요청사항</th><td><textarea name="divyRequest" rows="5" cols="50" class="input-text"><c:out value="${t.divyRequest}"/></textarea></td></tr>
          </table>
