...
<head>
    ...
    <!-- 상품등록 전용 스타일 -->
    <link rel="stylesheet" href="${ctxPath}/css/addProduct.css" type="text/css">
...
<div class="container">
    ...
    <form name="detailForm" method="post" action="${ctxPath}/product/addProduct" enctype="multipart/form-data">
        ...
        <table class="ct_box">
            ...
            <tr>
                ...
                <td class="ct_write01">
                    ...
                    <img src="${ctxPath}/images/ct_icon_date.gif"
                         class="icon-btn"
